...
> Python | Pandas | PostgreSQL | NLP | Streamlit

- Used **SQL queries** to extract, filter, and validate resume–job matching data from PostgreSQL tables.
- Performed **data cleaning and exploratory analysis** to ensure consistent and reliable results.
- Generated **analytical reports and visualizations** to communicate matching insights clearly.
...
- Built **ETL-style workflows** to ingest, clean, and standardize raw transactional sales data.
- Conducted **exploratory data analysis** to identify seasonal trends, anomalies, and performance patterns.
- Created **visual dashboards and reports** to support business decision-making.
...
- Prepared and analyzed **historical match data** using data cleaning and feature engineering.
- Conducted **exploratory analysis** to understand factors influencing match outcomes.
- Visualized insights and model outputs for **clear interpretation and analysis**.
